...
// Keyframes
float posX = PosIni.x, posY = PosIni.y, posZ = PosIni.z, rotRodIzq, rotRodDer, rotBraIzq, rotBraDer = 0;
...
void interpolation(void)
{
	...
	KeyFrame[playIndex].rotInc = (KeyFrame[playIndex + 1].rotBraIzq - KeyFrame[playIndex].rotBraIzq) / i_max_steps;
	KeyFrame[playIndex].rotInc = (KeyFrame[playIndex + 1].rotBraDer - KeyFrame[playIndex].rotBraDer) / i_max_steps;
}
...
void animacion()
{
	...
	if (play)
	{
		...
		else
		{
			...
			rotRodIzq += KeyFrame[playIndex].rotInc3;
